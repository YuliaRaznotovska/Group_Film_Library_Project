...
Revision ID: 59447636531e
Revises: 
Create Date: 2025-12-22 23:35:17.344231
...
def upgrade() -> None:
    ...
    sa.Column('actor_first_name', sa.String(length=50), nullable=False),
    sa.Column('actor_last_name', sa.String(length=255), nullable=False),
    ...
    sa.Column('added_info', sa.String(length=255), nullable=False),
